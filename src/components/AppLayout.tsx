...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-pale skin-50">
      <nav className="bg-white/80 backdrop-blur-md border-b sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="text-3xl font-black text-pale skin-600">ReFurrm</div>
          <div className="flex gap-4 items-center">
            <Link to="/pricing"><Button variant="ghost">Pricing</Button></Link>
            <Link to="/about"><Button variant="ghost">About</Button></Link>
            <CartIcon />
            {user ? (
              <Link to="/dashboard"><Button className="bg-pale skin-600">Dashboard</Button></Link>
            ) : (
              <Link to="/signup"><Button className="bg-pale skin-600">Start Free</Button></Link>
            )}
          </div>
        </div>
      </nav>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        <div className="inline-block mb-4 px-4 py-2 bg-pale skin-100 rounded-full">
          <span className="text-pale skin-700 font-semibold">Launch Your Empire in Minutes, Not Months</span>
        </div>
        ...
        <p className="text-2xl text-slate-700 mb-8 max-w-4xl mx-auto">
          ...
          <span className="text-pale skin-600 font-bold">You keep full creative control, copyright, and 100% of the profits.</span><br/>
          Assistants help only when you ask. Choose how much help you want at any time.
        </p>
        <div className="flex gap-4 justify-center mb-4">
          <Button onClick={() => handleDemoClick('artist')} size="lg" className="bg-pale skin-600 text-lg px-8">I'm an Artist</Button>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <h2 className="text-4xl font-black text-center mb-4">Three Simple Steps<br/><span className="text-pale skin-600">You Stay in Control</span></h2>
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          <Card className="p-8 text-center">
            <div className="text-5xl font-black text-pale skin-600 mb-4">1</div>
          ...
          <Card className="p-8 text-center">
            <div className="text-5xl font-black text-pale skin-600 mb-4">2</div>
          ...
          <Card className="p-8 text-center">
            <div className="text-5xl font-black text-pale skin-600 mb-4">3</div>
      ...
      {/* Benefits */}
      <section className="bg-pale skin-600 text-white py-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-pale skin-100">Upload once and get ready-to-review drafts that cut setup and marketing time by hours.</p>
            </div>
            <div>
              <h3 className="text-2xl font-bold mb-3">Creator Owned</h3>
              <p className="text-pale skin-100">You keep copyright, pricing authority, and final approval on every listing.</p>
            </div>
            <div>
              <h3 className="text-2xl font-bold mb-3">Flexible Help</h3>
              <p className="text-pale skin-100">Turn automation on or off per task. Request full guided setup or do everything yourself.</p>
            </div>
            <div>
              <h3 className="text-2xl font-bold mb-3">Sell Everywhere</h3>
              <p className="text-pale skin-100">One upload produces mockups, variants, and publishable drafts for multiple channels.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 text-center">
        ...
        <div className="space-y-4 text-lg text-slate-700">
          ...
          <p>Secure payments and transparent fees. <Link to="/terms" className="text-pale skin-600 underline">See our Creator Rights</Link> for details.</p>
        </div>
      </section>
